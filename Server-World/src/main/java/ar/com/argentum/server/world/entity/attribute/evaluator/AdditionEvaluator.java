...
/**
 * Encapsulate an {@linkplain Attribute.Evaluator} which evaluates as addition.
 */
@FunctionalInterface
public interface AdditionEvaluator extends Attribute.Evaluator {
    /**
     * {@inheritDoc}
     */
    @Override
    default double applyBonus(AttributeManager manager, double applyOn) {
        return getBonusApplied();
    }
